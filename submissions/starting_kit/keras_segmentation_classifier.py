...
class KerasSegmentationClassifier(BaseEstimator):
    ...
    def fit(self, img_loader):
        ...
        # make u-net
        ## ENCODING PATH ##
        conv1 = Conv3D(32, (3, 3), activation='relu', padding='same')(x)
        ...
        conv = Conv3D(filters=number_of_filters, 
                            kernel_size=convolution_kernel_size)(inputs)
        ...
        up2 = concatenate([Conv2DTranspose(256, (2, 2), strides=(2, 2), padding='same')(conv5), conv4], axis=3)
        conv2 = Conv2D(256, (3, 3), activation='relu', padding='same')(up6)
        conv2 = Conv2D(256, (3, 3), activation='relu', padding='same')(conv6)
    ...
    return conv10
        ...
        print('fitting, {}'.format(gen_train))
