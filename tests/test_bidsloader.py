...
class TestBIDSLoader(unittest.TestCase):
    ...
    def test_BIDSLoader_init_correct(self):
        ...
        bdc = BIDSLoader(root_dir=root_dir, data_entities=data_ent, target_entities=target_ent, batch_size=batch_size)
    ...
    def test_BIDSLoader_init_dataisderivatives_blank(self):
        ...
        bdc = BIDSLoader(root_dir=root_dir, data_entities=data_ent, target_entities=target_ent,
    ...
    def test_getmatchingimages_reqents(self):
        ...
        # Test directory has 4 images per subject and we shouldn't get the input image back
    ...
    def test_getmatchingimages_matching_ents(self):
        ...
        self.assertEqual(ses_im.get_entities()['session'], image_to_match.get_entities()['session'])
        return
